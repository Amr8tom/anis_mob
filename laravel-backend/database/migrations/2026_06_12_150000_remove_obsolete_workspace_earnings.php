...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $columns = array_filter([
            Schema::hasColumn('workspaces', 'payout_rate_cents_per_hour') ? 'payout_rate_cents_per_hour' : null,
            Schema::hasColumn('workspaces', 'payout_currency') ? 'payout_currency' : null,
        ]);
    ...
    public function down(): void
    {
        Schema::table('workspaces', function (Blueprint $table): void {
            $table->unsignedInteger('payout_rate_cents_per_hour')->default(0);
            $table->char('payout_currency', 3)->default('EGP');
        });

        Schema::create('workspace_earnings', function (Blueprint $table): void {
