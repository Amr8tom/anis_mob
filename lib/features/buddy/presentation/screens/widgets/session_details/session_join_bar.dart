...
class SessionJoinBar extends StatelessWidget {
  ...
  final bool isFull;
  const SessionJoinBar(
      {super.key, required this.session, required this.isFull});
            ...
            child: ElevatedButton(
              onPressed: isFull || isLoading
                  ...
                  : () => ActionGuard.run(
                        ...
                        action: () =>
                            context.read<BuddyCubit>().joinSession(session),
                      ),
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    isFull ? ColorRes.anisChipBg : ColorRes.anisGreen,
                disabledBackgroundColor: isFull ? ColorRes.anisChipBg : null,
                elevation: 0,
              ...
              child: isLoading
                  ...
                  : Text(
                      ...
                      style: tt.bodyLarge?.copyWith(
                        fontWeight: FontWeight.w700,
                        color: isFull ? ColorRes.anisHintText : ColorRes.white,
                      ),
                    ),
            ),
          );
