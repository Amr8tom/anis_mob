...
import 'widgets/profile/profile_completion_prompt.dart';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileCubit, ProfileState>(
      builder: (context, state) {
        if (state.isGuest) return const GuestProfileView();
...
// Removed private classes _GuestProfileView and _ProfileCompletionPrompt.
