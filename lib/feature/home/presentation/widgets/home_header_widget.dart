      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: ColorRes.white.withOpacity(0.12),
          ...
          Row(
            ...
            children: [
              Text(
                S.current.weeklyGoal,
                style: tt.bodySmall?.copyWith(
                  color: ColorRes.white.withOpacity(0.7),
                ),
              ),
              Text(
                '${(profile.subscriptionProgress * 100).toStringAsFixed(0)}%',
                style: tt.bodySmall?.copyWith(
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              minHeight: 6.h,
              backgroundColor: ColorRes.white.withOpacity(0.18),
              valueColor:
...
class _SubscriptionBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: ColorRes.anisGold.withOpacity(0.18),
        borderRadius: BorderRadius.circular(AppSizes.borderRadiusXLg),
        border: Border.all(
          color: ColorRes.anisGold.withOpacity(0.45),
          width: 1,
        ),
      ),
      child: Row(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: ColorRes.white.withOpacity(0.25), width: 2),
      ),
