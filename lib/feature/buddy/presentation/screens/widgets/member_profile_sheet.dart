...
class MemberProfileSheet extends StatelessWidget {
  ...
  Color _avatarBg() {
    switch (member.avatarColorKey) {
      case 'red':    return ColorRes.anisAvatarD;
      case 'blue':   return ColorRes.anisAvatarA;
      case 'purple': return ColorRes.anisAvatarC;
      case 'orange': return ColorRes.anisAvatarB;
      default:       return ColorRes.anisAvatarA;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(
        AppSizes.padding, AppSizes.sm, AppSizes.padding, AppSizes.xl,
      ),
      child: Column(
        ...
        children: [
            ...
            Container(
              ...
              child: Text(
                ...
                style: tt.bodySmall?.copyWith(
                  color: ColorRes.anisGold, fontWeight: FontWeight.w700,
                ),
              ),
            ),
          ...
          Text(
            ...
            style: tt.bodyMedium?.copyWith(
              color: ColorRes.anisGreen, fontWeight: FontWeight.w600,
            ),
          ),
          ...
          Align(
            ...
            child: Wrap(
              ...
              children: member.interests.map((interest) => Container(
                padding: EdgeInsets.symmetric(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(AppSizes.borderRadiusXLg),
                  border: Border.all(
                    color: ColorRes.anisGreen.withOpacity(0.2), width: 1,
                  ),
                ),
                child: Text(
                  interest,
...
class _StatBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: AppSizes.md + 4, vertical: AppSizes.sm,
      ),
      decoration: BoxDecoration(
